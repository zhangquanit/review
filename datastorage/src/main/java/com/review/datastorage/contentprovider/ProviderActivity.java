...
public class ProviderActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_process).setVisibility(View.GONE);
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_process:
                startActivity(new Intent(this,ProviderActivity2.class));
                break;
    ...
    ContentObserver contentObserver = new ContentObserver(new Handler(Looper.getMainLooper())) {
        ...
        public boolean deliverSelfNotifications() {
            System.out.println("ProviderActivity deliverSelfNotifications");
        ...
        public void onChange(boolean selfChange) {
            ...
            System.out.println("ProviderActivity onChange, selfChange=" + selfChange);
        }

        @Override
        public void onChange(boolean selfChange, Uri uri) {
            super.onChange(selfChange, uri);
            System.out.println("ProviderActivity onChange,selfChange=" + selfChange + ",uri=" + uri);
        }
    };
